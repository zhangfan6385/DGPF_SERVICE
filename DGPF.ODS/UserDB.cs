...
namespace DGPF.ODS
{
    public class UserDB
    {
        ...
        public string updateUserData(Dictionary<string, object> d) {
            ...
            sb.Append(" USER_CODE='" + d["USER_CODE"]==null?"": d["USER_CODE"] + "', ");
            sb.Append(" USER_NAME='" + d["USER_NAME"]==null?"": d["USER_NAME"] + "', ");
            sb.Append(" USER_ALIAS='" + d["USER_ALIAS"] == null ? "" : d["USER_ALIAS"] + "', ");
            sb.Append(" USER_PASS='" + d["USER_PASS"] == null ? "" : d["USER_PASS"] + "', ");
            sb.Append(" PHONE_MOBILE='" + d["PHONE_MOBILE"] == null ? "" : d["PHONE_MOBILE"] + "', ");
            sb.Append(" PHONE_OFFICE='" + d["PHONE_OFFICE"] == null ? "" : d["PHONE_OFFICE"] + "', ");
            sb.Append(" PHONE_ORG='" + d["PHONE_ORG"] == null ? "" : d["PHONE_ORG"] + "', ");
            sb.Append(" USER_EMAIL='" + d["USER_EMAIL"] == null ? "" : d["USER_EMAIL"] + "', ");
            sb.Append(" EMAIL_OFFICE='" + d["EMAIL_OFFICE"] == null ? "" : d["EMAIL_OFFICE"] + "', ");
            sb.Append(" USER_IP='" + d["USER_IP"] == null ? "" : d["USER_IP"] + "', ");
            sb.Append(" FLAG=" + d["FLAG"] == null ? "" : d["FLAG"] + ", ");
            sb.Append(" USER_SEX=" + d["USER_SEX"] == null ? "" : d["USER_SEX"] + ",");
            sb.Append(" USER_DOMAIN='" + d["USER_DOMAIN"] == null ? "" : d["USER_DOMAIN"] + "', ");
            sb.Append(" REMARK='" + d["REMARK"] == null ? "" : d["REMARK"] + "' ");
            sb.Append(" USER_ERP='"+d["USER_ERP"] == null ? "" : d["USER_ERP"] + "' ");
